...
# input_file = working_dir+'pruebas.txt'
...
Entrez.email = "elpisco@gmail.com"
cadena = sp + ' AND srcdb_refseq[PROP]'
cadena = cadena + ' AND '+tam1+'[SLEN]:'+tam2+'[SLEN]'
cadena = cadena + 'AND "1000/01/01"[Publication Date] : "'+fecha+'"[Publication Date]'
handle = Entrez.esearch(db="nucleotide", term=cadena)
